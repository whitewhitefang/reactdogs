    ...
    <div className='col'>
      <div className="card border-light h-100">
        ...
        <div className="card-body">
          ...
          <button className="btn btn-primary mb-0 d-flex card-spot-button text-center">Show me more</button>
        </div>
        <div className='card-footer d-flex'>
          ...
          <span className="text-end" title={props.spot.reviews.length + " reviews"}>
            ...
            <svg className="star ms-1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="gold" class="bi bi-star-fill" viewBox="0 0 20 20">
